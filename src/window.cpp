...
int APIENTRY main2(_In_ HINSTANCE hInstance,
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WIN32PROJECT1, g_szWindowClass, MAX_LOADSTRING);
    ...
    wcex.hIconSm = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ICONMAIN));
